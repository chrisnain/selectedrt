...
1. Under this link you can add twitter accounds that shoult be monitored. You
also have to add the official websides there.

2. It is planed to set a timer right here to automaticly look for tweets to
retweet.

3. Here you will find the list of tweets that allready have beer retweeted.

4. This is the Link to start the retweet process. 

http://twitter.com/PirateDev
